...
<%-- 			<%
			...
			%> --%>
	<form action="loginRegister?login=login" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="user" id="name" value="" placeholder="&nbsp;&nbsp;用户名/手机号"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
...
<div class="register_body">
	...
	<form action="loginRegister?login=register" class="register" method="post">
		<div class="nav">
			<div class="nav register_nav">
				...
				<div class="col-xs-6">
					<input type="text" name="user" id="name_r" value="" placeholder="&nbsp;&nbsp;用户名/手机号" onBlur="javascript:ok_or_errorByRegister(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
